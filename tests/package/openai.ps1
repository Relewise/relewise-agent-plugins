...
if ($manifest.description -ne 'Work with your Relewise configuration, analytics and optimization using AI.') { throw 'Codex plugin manifest has an unexpected product description.' }
