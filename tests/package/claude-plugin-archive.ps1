...
foreach ($requiredPath in @('.mcp.json', 'skills\relewise-core\SKILL.md', 'skills\relewise-agent-gateway\SKILL.md', 'skills\relewise-agent-gateway\references\transport-selection.md', 'skills\relewise-agent-gateway\scripts\relewise-agent', 'skills\relewise-agent-gateway\scripts\relewise-agent.ps1', 'LICENSE')) {
