...
Gemini connects Agent Gateway through OAuth discovery and manages sign-in. The generated extension manifest contains no PAT setting, header, or environment mapping.
