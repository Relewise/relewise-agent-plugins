...
$artifactsRoot = [IO.Path]::GetFullPath((Join-Path $repositoryRoot 'artifacts\openai'))
...
Write-Host "Packaged OpenAI Codex plugin for $RuntimeIdentifier at $packageRoot"
