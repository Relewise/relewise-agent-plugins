...
$artifactsRoot = [IO.Path]::GetFullPath((Join-Path $repositoryRoot 'artifacts\github-copilot'))
...
& "$PSScriptRoot/write-plugin-configuration.ps1" -PluginName relewise -Vendor github-copilot -OutputRoot $packageRoot
